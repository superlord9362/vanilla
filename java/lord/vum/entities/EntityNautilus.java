...
public class EntityNautilus extends EntityWaterMob {
	...
	public void onLivingUpdate() {
		...
		this.targetYaw = MathHelper.wrapDegrees((float) (MathHelper.atan2( this.motionZ/f1,this.motionX/f1)*(180f/Math.PI))-90f-this.rotationYaw);
	...
	public void setMovementVector(float randomMotionVecXIn, float randomMotionVecYIn, float randomMotionVecZIn)
	{
		...
		double f1 = MathHelper.sqrt(randomMotionVecX*randomMotionVecX+randomMotionVecY*randomMotionVecY+randomMotionVecZ*randomMotionVecZ);
		this.targetPitch = (float) (Math.asin(this.randomMotionVecY/f1)*(180f/Math.PI));
	}
	...
	static class AIFleeFromPlayer extends EntityAIBase{
		...
		public boolean shouldExecute() {
			...
			return nautilus.isInWater()&&fleeTarget!=null;
		}
		...
		public void updateTask() {
			...
			float multiplier = 5/20f;


			vecX = nautilus.randomMotionVecX+(vecX-nautilus.randomMotionVecX)*multiplier;
			vecY = nautilus.randomMotionVecY+(vecY-nautilus.randomMotionVecY)*multiplier;
			vecZ = nautilus.randomMotionVecZ+(vecZ-nautilus.randomMotionVecZ)*multiplier;
