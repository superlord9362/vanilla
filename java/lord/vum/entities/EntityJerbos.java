...
public class EntityJerbos extends EntityAnimal
{
    private static final DataParameter<Integer> RABBIT_TYPE = EntityDataManager.<Integer>createKey(EntityJerbos.class, DataSerializers.VARINT);
    ...
    public EntityJerbos(World worldIn)
    {
        super(worldIn);
        this.setSize(0.4F, 0.5F);
        this.jumpHelper = new EntityJerbos.RabbitJumpHelper(this);
        this.moveHelper = new EntityJerbos.RabbitMoveHelper(this);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(1, new EntityJerbos.AIPanic(this, 2.2D));
        ...
        this.tasks.addTask(4, new EntityJerbos.AIAvoidEntity(this, EntityPlayer.class, 8.0F, 2.2D, 2.2D));
        this.tasks.addTask(4, new EntityJerbos.AIAvoidEntity(this, EntityWolf.class, 10.0F, 2.2D, 2.2D));
        this.tasks.addTask(4, new EntityJerbos.AIAvoidEntity(this, EntityMob.class, 4.0F, 2.2D, 2.2D));
        this.tasks.addTask(5, new EntityJerbos.AIRaidFarm(this));
    ...
    public void updateAITasks()
    {
        ...
        if (this.onGround)
        {
            ...
            EntityJerbos.RabbitJumpHelper entityrabbit$rabbitjumphelper = (EntityJerbos.RabbitJumpHelper)this.jumpHelper;
    ...
    {
        ((EntityJerbos.RabbitJumpHelper)this.jumpHelper).setCanJump(true);
    }

    private void disableJumpControl()
    {
        ((EntityJerbos.RabbitJumpHelper)this.jumpHelper).setCanJump(false);
    }
    ...
    {
        EntityLiving.registerFixesMob(fixer, EntityJerbos.class);
    }
    ...
    public EntityJerbos createChild(EntityAgeable ageable)
    {
        EntityJerbos entityrabbit = new EntityJerbos(this.world);
        int i = this.getRandomRabbitType();

        if (this.rand.nextInt(20) != 0)
        {
            if (ageable instanceof EntityJerbos && this.rand.nextBoolean())
            {
                i = ((EntityJerbos)ageable).getRabbitType();
            }
            else
            {
    ...
    public void setRabbitType(int rabbitTypeId)
    {
        if (rabbitTypeId == 99)
        {
            ...
            this.tasks.addTask(4, new EntityJerbos.AIEvilAttack(this));
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof EntityJerbos.RabbitTypeData)
        {
            i = ((EntityJerbos.RabbitTypeData)livingdata).typeData;
            flag = true;
        }
        else
        {
            livingdata = new EntityJerbos.RabbitTypeData(i);
        }
    ...
    static class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T>
        {
            private final EntityJerbos rabbit;

            public AIAvoidEntity(EntityJerbos rabbit, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_, double p_i46403_6_)
            {
    ...
    static class AIEvilAttack extends EntityAIAttackMelee
        {
            public AIEvilAttack(EntityJerbos rabbit)
            {
    ...
    static class AIPanic extends EntityAIPanic
        {
            ...
            public AIPanic(EntityJerbos rabbit, double speedIn)
            {
    ...
    static class AIRaidFarm extends EntityAIMoveToBlock
        {
            ...
            public AIRaidFarm(EntityJerbos rabbitIn)
            {
    ...
    public class RabbitJumpHelper extends EntityJumpHelper
    {
        ...
        public RabbitJumpHelper(EntityJerbos rabbit)
        {
            super(rabbit);
            this.rabbit = rabbit;
        }
    ...
    static class RabbitMoveHelper extends EntityMoveHelper
        {
            ...
            public RabbitMoveHelper(EntityJerbos rabbit)
            {
                super(rabbit);
                this.rabbit = rabbit;
            }
            ...
            {
                if (this.rabbit.onGround && !this.rabbit.isJumping && !((EntityJerbos.RabbitJumpHelper)this.rabbit.jumpHelper).getIsJumping())
                {
