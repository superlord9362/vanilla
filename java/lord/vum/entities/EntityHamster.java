...
public class EntityHamster extends EntityTameable {
	...
	public EntityHamster createChild(EntityAgeable ageable) {
		...
		EntityHamster entityocelot = new EntityHamster(this.world);
	...
	public boolean canMateWith(EntityAnimal otherAnimal) {
		...
		} else if (!(otherAnimal instanceof EntityHamster)) {

			return false;

		} else {

			EntityHamster entityocelot = (EntityHamster) otherAnimal;
